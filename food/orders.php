  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
              <a href="restaurantdetails.php">
                <div class="detail">
                  <img src="images/flames.png">
                  <p class="resname">Foodiezzz</p>
                </div>
              </a>
            </nav>
        </div>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM orders  WHERE customer_id = $id;");
...
<div id="work-collections" class="seaction">
					...
					$sql = mysqli_query($con, "SELECT * FROM orders WHERE customer_id = $id AND status LIKE '$status';");
					echo '              <div class="row">
                <div>
